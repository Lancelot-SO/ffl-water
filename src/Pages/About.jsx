                            ...
                            <div className="absolute top-[20%] lg:left-[200px] lg:w-[1130px] lg:h-[410px] h-[1250px]
                                ...
                                <div className="flex flex-col lg:w-[500px] h-full p-5 items-start justify-center">
                                    ...
                                    <p className="text-[18px] mb-5">
                                        At FFL Water Features, we pride ourselves with providing and maintaining the highest standards of service;
                                        our client portfolio is a testament of our unique work ethic, precision and attention to detail.
                                    </p>
                                    <button
