                ...
                <div className='w-full lg:h-screen h-[800px] relative'>
                    ...
                    <div className='absolute top-[25%] lg:left-[200px] lg:w-[1130px] lg:h-[380px]
                        ...
                        <h1 className='lg:text-[45px] text-[32px] leading-10 font-bold mb-14'>
                            " When life places stones in your path, be the water. A persistent drop of water will wear
                            away even the hardest stone."
                        </h1>
                            ...
                            <div className='absolute inset-0 w-full flex'>
                                <div className='flex flex-col flex-1 pl-6 py-4'>
                                    ...
                                    <p className='text-[#0F172A] w-[350px]'>
                                        We are members of the elite CAC (Certified Aquascape Contractors) group, the largest association of pond builders in the world and we are the 1st and the only Certified Aquascape Contractors in Africa having gone through rigorous training in pond building techniques and business management from the Aquascape Incin the USA.
                                    </p>
                                </div>
