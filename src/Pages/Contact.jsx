    ...
    return (
        <div className='w-screen h-screen relative'>
            ...
            <div className='absolute w-full lg:top-[350px] lg:gap-0 gap-6 top-36 flex lg:flex-row flex-col items-center justify-between text-white lg:px-[200px] px-4'>
                ...
                <motion.div initial='hidden' animate='visible' custom={4} variants={fadeUpVariants} className='lg:text-right text-left max-w-md'>
                    <p className='font-semibold text-[15px] mb-4'>CONSULTANT INFORMATION</p>
                    <p className='text-[12px] leading-relaxed w-[360px]'>
                        To ensure dedicated service, we require a commitment fee of GHC800 for every 50 km traveled outside Accra. This fee must be paid before our design consultant visits your home to collaborate with you on a custom water feature tailored to your landscape. If the project moves forward, the fee will be credited to your final bill within three months of payment.                    </p>
                    <motion.button
                        initial='hidden'
                        animate='visible'
                        custom={5}
            ...
            {showForm && (
                ...
                >
                    <div
                        className='mt-[70px] bg-[#1e293b] p-8 border-2 border-[#5882C1] rounded-lg shadow-lg w-[580px] max-w-full'
            ...
            {showSecondForm && (
                ...
                >
                    <div
                        className='bg-[#1e293b] border-2 border-[#5882C1] p-8 rounded-lg shadow-lg w-[580px] max-w-full'
                        onClick={(e) => e.stopPropagation()}
                    >
                        <div className='flex justify-between items-center mb-4'>
