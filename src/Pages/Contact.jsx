...
const Contact = () => {
    ...
    return (
        <div className='w-screen h-screen relative'>
            ...
            <div className='absolute w-full lg:top-[350px] top-[20%] flex lg:flex-row flex-col lg:items-center justify-between text-white lg:px-24 md:px-20 px-4 gap-6 lg:gap-6 md:gap-10'>
                {/* Left Section */}
